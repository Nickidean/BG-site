    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-green-300 mt-2 text-sm">Recognise the coaches who go the extra mile</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              {loadingCoaches ? (
                ...
                <select
                  ...
                  required
                  className="w-full rounded-lg bg-white/10 border border-white/20 text-white px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-400"
                >
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••"
                required
                className="w-full rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/40 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-400 tracking-widest text-center text-lg"
              />
            </div>
